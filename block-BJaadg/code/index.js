...
*/
console.log(`${from.concat(quote)} to ${to}`)
/*
...
*/
let store =``; 
store=store.padStart(`15`,`.`);

console.log(store.concat(quote))
/*
...
*/
console.log(quote.replace("tomorrow","today"))
/*
...
*/
let addDot=quote.slice(0,30)
console.log(addDot.concat(`...`))
/*
